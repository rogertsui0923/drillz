...
$( document ).ready(function() {
  ...
  $('.password-field').on('keyup', function({currentTarget}){
    ...
    if (passwordStrength === 0) {
      $('.lightsaber').attr("src", "/assets/saberHandle-7be9aab3ef14a5a72f1cbc78495ac0c73fdd11ee6161fc00e3499565000dba43.svg");
      $('.password-status').html("");
    } else if (passwordStrength === 1) {
      $('.lightsaber').attr("src", "/assets/smallSaber-ecdb67b5c0d8663c50203b23c4b4ec23ff51cec971d058356b666ef8022ed75e.svg");
      let status = 'Weak';
      $('.password-status').html(status);
    } else if (passwordStrength === 2){
      $('.lightsaber').attr("src", "/assets/mediumSaber-b528c6699f870883ae49854c8c995bb2ea040951163521db92f00a00fc149c6d.svg");
      let status = 'Medium';
      $('.password-status').html(status);
    } else if (passwordStrength === 3) {
      $('.lightsaber').attr("src", "/assets/bigSaber-c5ee5884cc15a87f3c9adf6ab492b5dda23e1e2afed3ec4dfbcd7c05c0384246.svg");
      let status = 'Strong';
      $('.password-status').html(status);
    }
